...
.init_readme_std_contents_rmd <- function() {
  c(
    "# README",
    "",
...
.init_readme_std_contents_md <- function() {
  c(
    "# README",
    "",
    "The purpose of this project is to",
    ...
    "",
    "For detailed run information, including scripts run and configurations used, see [BUILDLOG.md](./BUILDLOG.md).",
    ""
  )
}
...
.init_desc_std_contents <- function() {
  c(
    ...
    "Version: 0.0.1",
    "Authors@R:",
    "    person(given = \"Jo\", family = \"Doe\", email = \"jodoe@dom.ain\", role = c(\"aut\", \"cre\"))",
