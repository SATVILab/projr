...
test_that(".log_build_append adds messages to log", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      # Append messages
      .log_build_append(log_file, "Test message 1", "info")
      .log_build_append(log_file, "Test message 2", "debug")
      .log_build_append(log_file, "Test message 3", "success")
...
test_that(".log_build_append handles NULL log_file", {
  ...
  expect_no_error(.log_build_append(NULL, "Test message", "info"))
})
...
test_that(".log_build_section adds section headers", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      # Add section
      .log_build_section(log_file, "Test Section")
...
test_that(".log_build_finalize adds summary", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      .log_build_finalize(log_file, success = TRUE, start_time = start_time)
...
test_that(".log_build_finalize marks failures", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      .log_build_finalize(log_file, success = FALSE)
  ...
  usethis::with_project(
    ...
    code = {
      ...
      .log_history_add(
        ...
        msg = "Test build",
        success = TRUE,
        log_file = "/path/to/2024-Jan-15/12-30-45.qmd"
      )
...
test_that("log system integrates with build process", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      .log_build_section(log_file, "Initialization")
      .log_build_append(log_file, "Starting build", "info")
      
      .log_build_section(log_file, "Compilation")
      .log_build_append(log_file, "Compiling files", "info")
      .log_build_append(log_file, "Compilation successful", "success")
      
      .log_build_section(log_file, "Testing")
      .log_build_append(log_file, "Running tests", "info")
      .log_build_append(log_file, "All tests passed", "success")
