test_that("projr_manifest_hash_dir works", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      expect_true(file.exists("_archive/manifest.rds"))
      file.remove("_output/manifest.csv")
      file.remove("_output/manifest.rds")
      file.remove("_archive/manifest.csv")
      file.remove("_archive/manifest.rds")
      yml_projr <- yml_projr_init
