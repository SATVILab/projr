test_that(".manifest_hash_label works", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      path_dir_empty <-.path_get_dir("raw-data")
...
test_that(".build_manifest_* works", {
  ...
  usethis::with_project(
    ...
    code = {
      ...
      for (x in label_vec) {
        .dir_rm.path_get_dir(x, safe = TRUE, create = FALSE))
      ...
      .dir_rm.path_get_dir("docs", safe = FALSE))
      .dir_rm.path_get_dir("output", safe = FALSE))
