...
This specifies that, after the project is built, the `raw-data` directory (i.e. the contents of `_data_raw`) is uploaded to GitHub as a release whose name is `input`.
